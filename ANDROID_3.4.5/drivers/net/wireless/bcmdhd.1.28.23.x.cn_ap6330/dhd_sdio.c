...
extern int nvram_flag;//add by dulong
	...
	switch (chip) {
		case BCM4330_CHIP_ID:
			if (ag_type == FW_TYPE_G) {
				...
				nvram_flag = 1;//nvram_ap6330.txt
				printk("set nvram_flag to 1 -> ap6330\n");
				break;
			}
		case BCM43362_CHIP_ID:
			if (chiprev == BCM43362A0_CHIP_REV)
				...
				nvram_flag = 2;//nvram_ap6210.txt
				printk("set nvram_flag to 2 -> ap6210\n");
			}
			break;
